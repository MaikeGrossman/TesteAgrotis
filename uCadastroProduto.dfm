object FrmCadastroProduto: TFrmCadastroProduto
  ...
  object qryCodigoProduto: TIBQuery
    Database = dmBanco.dbBanco
    Transaction = dmBanco.Transaction
    SQL.Strings = (
      'SELECT (GEN_ID(generator_idproduto, 0)) as id FROM RDB$DATABASE')
    Left = 544
    Top = 88
    object qryCodigoProdutoID: TLargeintField
      FieldName = 'ID'
      ProviderFlags = []
    end
  end
